...
class Booking(webdriver.Chrome):
    ...
    def select_adults(self, count=1):
        ...
        while True:
            ...
            #if the value of adults reaches 1, then we would get out of the while loop
    ...
    def report_results(self):
        hotel_boxes = self.find_element_by_id('ajaxsrwrap').find_element_by_class_name('a826ba81c4 fe821aea6c fa2f36ad22 afd256fc79 d08f526e0d ed11e24d01 da89aeb942')
        print(hotel_boxes)
